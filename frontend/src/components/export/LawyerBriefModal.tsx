...
export const LawyerBriefModal: React.FC<LawyerBriefModalProps> = ({ documentId }) => {
  ...
  return (
    <div className="mx-auto max-w-5xl p-4 sm:p-6 space-y-6">
      {/* Top Header Card */}
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 rounded-2xl border border-slate-200 bg-white p-6 shadow-sm dark:border-slate-800 dark:bg-slate-900">
        <div>
          <span className="rounded-full bg-blue-100 px-2.5 py-0.5 text-xs font-bold text-blue-800 dark:bg-blue-900 dark:text-blue-200">
            One-Page Dossier
          </span>
        ...
        <div className="flex items-center gap-2">
          <button
            onClick={handleCopy}
            className="flex items-center gap-1.5 rounded-xl border border-slate-200 bg-slate-50 px-3.5 py-2 text-xs font-semibold text-slate-700 hover:bg-slate-100 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-300 transition"
          >
          ...
          <button
            ...
            className="flex items-center gap-1.5 rounded-xl bg-blue-600 px-4 py-2 text-xs font-semibold text-white shadow hover:bg-blue-700 transition focus-visible:ring-2 focus-visible:ring-blue-500"
          >
      ...
      <div className="rounded-xl border border-amber-200 bg-amber-50 p-4 text-xs text-amber-900 dark:border-amber-900/60 dark:bg-amber-950/40 dark:text-amber-300">
        <p>
          <strong>Notice to Client & Attorney:</strong> {brief.disclaimer} This document serves as an analytical briefing sheet to assist counsel during consultation.
        </p>
      </div>
