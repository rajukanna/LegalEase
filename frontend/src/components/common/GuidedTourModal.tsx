    ...
    >
      <div className="w-full max-w-lg rounded-3xl bg-white p-6 shadow-2xl dark:bg-slate-900 dark:border dark:border-slate-800 relative">
        ...
        <div className="flex items-center gap-2 mb-3">
          ...
          <span className="text-xs text-slate-400 font-medium">Evaluator Guide</span>
        </div>
        ...
        {step === 1 && (
          <div className="space-y-3">
            ...
            <h3 id="tour-modal-title" className="text-base font-bold text-slate-900 dark:text-white">
              Welcome to LegalEase: Grounded AI for Everyday Legal Rights
            </h3>
            ...
            <div className="rounded-xl border border-blue-200 bg-blue-50/60 p-3 text-xs text-blue-900 dark:border-blue-900/50 dark:bg-blue-950/40 dark:text-blue-200">
        ...
        {step === 2 && (
          <div className="space-y-3">
            ...
            <h3 id="tour-modal-title" className="text-base font-bold text-slate-900 dark:text-white">
              Multi-Modal Risk Flags & Click-to-Scroll
            </h3>
            <p className="text-xs sm:text-sm text-slate-600 dark:text-slate-300 leading-relaxed">
        ...
        <div className="mt-6 flex items-center justify-between border-t border-slate-100 pt-4 dark:border-slate-800">
          <button
            onClick={handlePrev}
            disabled={step === 1}
            className="flex items-center gap-1 rounded-lg px-3 py-1.5 text-xs font-semibold text-slate-600 hover:bg-slate-100 dark:text-slate-400 dark:hover:bg-slate-800 disabled:opacity-30"
          >
          ...
          <div className="flex items-center gap-2">
            {step === totalSteps ? (
              <button
                ...
                className="flex items-center gap-1.5 rounded-xl bg-blue-600 px-4 py-2 text-xs font-bold text-white shadow hover:bg-blue-700 transition focus-visible:ring-2 focus-visible:ring-blue-500"
              >
                <span>Start Demo with Sample Lease</span>
